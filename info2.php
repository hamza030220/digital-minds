...
<div class="topbar">
    ...
    <div class="nav-links">
        ...
        <!-- Affichage du nom/prénom et de l'icône de l'utilisateur -->
<div class="user-info">
    <?php
    $photoFile = !empty($user['photo']) ? 'uploads/' . $user['photo'] : 'uploads/default-profile.jpg';

    // Vérifie si le fichier existe
    if (!file_exists($photoFile)) {
        $photoFile = 'uploads/default-profile.jpg'; // image par défaut si non trouvée
    }
    ?>
    <img src="<?php echo htmlspecialchars($photoFile); ?>" alt="Photo de profil" class="user-icon">
    ...
    if (isset($_GET['action']) && $_GET['action'] === 'infos') {
        ...
        echo '<table>
                ...
                <tr>
                    ...
                    <td>' . htmlspecialchars($utilisateur['gouvernorat']) . '</td>
                    <td>
