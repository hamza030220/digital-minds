...
// Set secure headers before any output
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        error_log("Error adding trajet: " . $e->getMessage());
        $error = "Une erreur est survenue lors de l'ajout du trajet: " . htmlspecialchars($e->getMessage());
    } catch (Exception $e) {
...
<body class="d-flex">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" id="trajetForm" novalidate>
                                ...
                                <div class="d-flex justify-content-between mt-4">
                                    ...
                                    <button type="submit" class="btn btn-success"><i class="bi bi-save me-2"></i>Enregistrer le trajet</button>
                                </div>
                            </form>
                        </div>
                    </div>
    ...
    <script src="../../public/assets/js/scripts_trajets_add.js"></script>
    <script>
