        ...
        <form method="POST" action="sign_up.php" enctype="multipart/form-data">
            <table class="registration-table">
                ...
                <tr><td><label for="gouvernorats">Gouvernorat</label></td>
                    <td>
                        <select name="gouvernorats" required>
                            <?php
                            $gouvernorats = ["Ariana","Beja","Ben Arous","Bizerte","Gabes","Gafsa","Jendouba","Kairouan","Kasserine","Kebili","Kef","Mahdia","Manouba","Medenine","Monastir","Nabeul","Sfax","Sidi Bouzid","Siliana","Sousse","Tataouine","Tozeur","Tunis","Zaghouan"];
