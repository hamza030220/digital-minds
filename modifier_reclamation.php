...
<body>
    <header>
        ...
        <nav class="nav-right">
            <ul>
                <li>
                    <form action="modifier_reclamation.php?id=<?php echo htmlspecialchars($reclamation_id); ?>" method="POST" id="lang-toggle-form">
    ...
    <main>
        ...
        <div class="content-container">
            ...
            <?php if ($reclamation && $can_modify): ?>
                <form action="modifier_reclamation.php?id=<?php echo htmlspecialchars($reclamation_id); ?>" method="POST" id="reclamationForm" novalidate>
