    ...
    <script>
        ...
        function updateCalculatedFields() {
            ...
            if (!isNaN(distance) && distance > 0) {
                document.getElementById('co2_saved').value = (distance * 160).toFixed(2);
                document.getElementById('battery_energy').value = (distance * 5.6).toFixed(2);
                document.getElementById('fuel_saved').value = (distance * 0.075).toFixed(3);
            } else {
                document.getElementById('co2_saved').value = '';
                document.getElementById('battery_energy').value = '';
                document.getElementById('fuel_saved').value = '';
            }
        }
        
        // Update calculated fields when distance input changes
        document.getElementById('distance').addEventListener('input', updateCalculatedFields);
        ...
        function calculateDistance(coordinates) {
            ...
            updateCalculatedFields(); // <-- Add this line
        }
    ...
    // If both markers are set, fit map to show both
     if (startMarker && endMarker) {
      ...
      return marker;
        ...
        // Update calculated fields on page load if distance is present
