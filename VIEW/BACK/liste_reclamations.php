...
// Fetch reclamations
if (!$isAdmin) { // Ne récupérer les données que si l'utilisateur n'est pas admin
    try {
...
<body>
        ...
        <div class="content-container">
            <?php if ($isAdmin): ?>
                <div class="error-message">
                    Accès réservé aux utilisateurs non-admin.
                </div>
            ...
            <?php elseif (!empty($reclamations)): ?>
                ...
                <div class="table-container">
                        ...
                        <tbody>
                            <?php foreach ($filteredReclamations as $reclamation): ?>
                                <tr data-type="<?php echo htmlspecialchars($reclamation['type_probleme']); ?>" data-status="<?php echo htmlspecialchars($reclamation['statut']); ?>">
                                    ...
                                    <td>
                                        <a href="../../VIEW/reclamation/repondre_reclamation.php?id=<?php echo $reclamation['id']; ?>" class="btn"><?php echo t('respond'); ?></a>
                                    </td>
                                    <td>
                    ...
                    <div class="pagination">
                        <a href="../../VIEW/reclamation/liste_reclamations.php?page=<?php echo $currentPage - 1; ?>" class="<?php echo $currentPage <= 1 ? 'disabled' : ''; ?>">
                            <?php echo t('previous'); ?>
                        </a>
                        <span><?php echo t('page') . ' ' . $currentPage . ' / ' . $totalPages; ?></span>
                        <a href="../../VIEW/reclamation/liste_reclamations.php?page=<?php echo $currentPage + 1; ?>" class="<?php echo $currentPage >= $totalPages ? 'disabled' : ''; ?>">
                            <?php echo t('next'); ?>
                        </a>
                    </div>
                </div>
    ...
    <script>
        ...
        function updatePaginationControls(filteredCount) {
            ...
            prevLink.href = `../../VIEW/reclamation/liste_reclamations.php?page=${currentPage - 1}`;
            nextLink.href = `../../VIEW/reclamation/liste_reclamations.php?page=${currentPage + 1}`;
