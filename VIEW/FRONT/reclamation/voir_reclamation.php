...
<body>
    ...
    <div class="sidebar">
        ...
        <ul>
            <li><a href="../../VIEW/reclamation/stats.php">🏠 Dashboard</a></li>
            <li><a href="">🚲 Reservation</a></li>
            <li><a href="../../VIEW/reclamation/reclamations_utilisateur.php">📋 Reclamation</a></li>
    ...
    <div class="container">
        ...
        <?php if (!$isLoggedIn): ?>
            <div class="feedback-message error">
                Vous devez vous connecter pour accéder à cette page. <a href="../../VIEW/BACK/login.php">Connexion</a>.
            </div>
        <?php elseif (!$isAdmin): ?>
            <div class="feedback-message error">
