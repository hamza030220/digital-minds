...
<body>
    <header>
        ...
        <nav class="nav-right">
            <ul>
                <li>
                    <form action="../../VIEW/reclamation/ajouter_reclamation.php" method="POST" id="lang-toggle-form">
    ...
    <main>
        ...
        <div class="container">
            ...
            <?php else: ?>
                <form action="../../CONTROLLER/ReclamationController.php" method="POST" id="reclamationForm" novalidate>
                    <label for="titre">
