...
<div class="main-content">
    ...
    <div class="reservation-card">
        ...
        <?php else: ?>
            <div class="bike-grid">
                <?php
                // Define image mapping for bike types
                $bike_images = [
                ...
                foreach ($bikes as $bike):
                    // Select image based on bike type, default to vv.jpg if type not found
                    $image = isset($bike_images[$bike['type_velo']]) ? $bike_images[$bike['type_velo']] : '/projetweb/images/vv.jpg';
                ?>
                    <div class="bike-card">
                        <img src="<?php echo htmlspecialchars($image); ?>" alt="<?php echo htmlspecialchars($bike['type_velo']); ?>">
                        <div class="bike-info">
