...
try {
    ...
    // Fetch notifications for the user based on the reclamations they created
    $stmt = $pdo->prepare("
    ...
    $updateStmt = $pdo->prepare("UPDATE notification SET is_read = 1 WHERE user_id = ? AND is_read = 0");
    $updateStmt->execute([$user_id]);
} catch (PDOException $e) {
    error_log("Error fetching notification: " . $e->getMessage());
    $errorMessage = t('error_database_notification');
}
?>
    ...
    <header>
        ...
        <nav class="nav-right">
            <ul>
                ...
                <li>
                    <form action="../../VIEW/reclamation/notifications.php" method="POST" id="lang-toggle-form">
            ...
            <?php else: ?>
                <ul class="notification-list">
                    <?php foreach ($notifications as $notification): ?>
                        <li>
                            <a href="../../VIEW/reclamation/repondre_reclamation.php?id=<?php echo $notification['reclamation_id']; ?>">
                            ...
                            <div>
                                ...
                                <a href="../../CONTROLLER/supprimer_notification.php?id=<?php echo $notification['id']; ?>" class="delete-btn">✖</a>
                            </div>
                        </li>
                    <?php endforeach; ?>
                </ul>
            <?php endif; ?>
            <a href="../../VIEW/reclamation/liste_reclamations.php" class="back-button"><?php echo t('back_to_list'); ?></a>
        </div>
    </main>
</body>
</html>