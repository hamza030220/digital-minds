...
if (!isset($_SESSION['user_id'])) {
    header('Location: ../BACK/login.php?error=' . urlencode(t('error_session_required')));
    exit;
}
...
if (isset($_GET['id'])) {
    ...
    if ($reclamation_id_temp !== false) {
        ...
        try {
            ...
            if (!$reclamation) {
                ...
                if (!$isAdmin && $reclamation['utilisateur_id'] != $user_id) {
                    $can_modify = false;
                    $feedback_message = t('access_restricted');
                    $feedback_type = 'error';
                }
        ...
        if ($can_modify && $reclamation && $_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $valid_types = ['mecanique', 'batterie', 'ecran', 'pneu', 'autre'];
...
<body>
    <header>
        ...
        <nav class="nav-right">
            <ul>
                <li>
                    <form action="../../VIEW/reclamation/modifier_reclamation.php?id=<?php echo htmlspecialchars($reclamation_id); ?>" method="POST" id="lang-toggle-form">
    ...
    <main>
        ...
        <div class="content-container">
            ...
            <?php if ($reclamation && $can_modify): ?>
                <form action="../../VIEW/reclamation/modifier_reclamation.php?id=<?php echo htmlspecialchars($reclamation_id); ?>" method="POST" id="reclamationForm" novalidate>
                    ...
                    <a href="../../VIEW/reclamation/liste_reclamations.php" style="margin-left: 10px;"><?php echo t('cancel'); ?></a>
                    <p><a href="../../VIEW/reclamation/liste_reclamations.php"><?php echo t('back_to_list'); ?></a></p>
                </form>
            <?php elseif ($reclamation && !$can_modify): ?>
                <p class="error-message"><a href="../../VIEW/reclamation/liste_reclamations.php"><?php echo t('back_to_list'); ?></a></p>
