...
if ($reclamationId <= 0) {
    header('Location: ../../VIEW/reclamation/liste_reclamations.php?error=' . urlencode(t('invalid_reclamation_id')));
    exit;
}
...
try {
    ...
    if (!$reclamation || $reclamation['utilisateur_id'] != $user_id) {
        header('Location: ../../VIEW/reclamation/liste_reclamations.php?error=' . urlencode(t('reclamation_not_found')));
        exit;
    }
...
<body>
    <header>
        ...
        <nav class="nav-right">
            <ul>
                <li>
                    <form action="../../VIEW/reclamation/detail.php?id=<?php echo htmlspecialchars($reclamationId); ?>" method="POST" id="lang-toggle-form">
        ...
        <div class="content-container">
            ...
            <?php elseif ($reclamation): ?>
                <div class="details-container">
                    ...
                    <a href="../../VIEW/reclamation/liste_reclamations.php" class="btn"><?php echo t('back_to_list'); ?></a>
                </div>
            <?php endif; ?>
        </div>
    </main>
